package com.cars_showroom.config;
...
import com.cars_showroom.db.cars_showroom_db.entity.User;
...
public class SwaggerConfiguration {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.cars_showroom.controller"))
				.paths(regex("/.*")).build();
